...
then
    wget https://static.rust-lang.org/dist/rust-1.86.0-powerpc64le-unknown-linux-gnu.tar.gz
    tar -xzf rust-1.86.0-powerpc64le-unknown-linux-gnu.tar.gz
    cd rust-1.86.0-powerpc64le-unknown-linux-gnu
    sudo ./install.sh
